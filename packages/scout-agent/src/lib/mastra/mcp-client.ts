...
export async function connectToMcpServer(
  ...
  for (const toolName of Object.keys(tools)) {
    ...
    if (
      ...
      // {"toolName":"browser_browser_snapshot","result":{"error":true,"message":"Tool validation failed for browser_browser_snapshot. Please fix the following errors and try again:\n- root: Invalid input: expected object, received undefined\n\nProvided arguments: undefined","validationErrors":{"_errors":["Invalid input: expected object, received undefined"]}}}
